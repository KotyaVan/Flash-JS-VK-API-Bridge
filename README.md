...
### Еще пару слов...
В коде достаточно много комментариве - это на случай, если кто-то захочет понять, как работает эта библиотека, как происходит инициализация и другое. В любом случае, понимать как она работает не обязательно, Вы можете скачать исходники и попробовать использовать ее в своем проекте, без понимания ее устройства.
